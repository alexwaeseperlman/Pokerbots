      ...
      <Card>
        ...
        {profile === null && (
          <Typography level="body-sm">
            You must complete your profile before you can join or create a team.
          </Typography>
        )}
        ...
        <FormControl>
          ...
          <FormHelperText>
            ...
            "Other". Only students at the listed schools are eligible for
            prizes.
          </FormHelperText>
        </FormControl>
        ...
        >
          ...
          <Button
            onClick={() => {
              if (
                confirm(
                  "Do you confirm that all of your information is correct?"
                )
              ) {
